export function initializeCalendar() {
    ...
    function renderCalendar(date) {
        ...
        for (let day = 1; day <= lastDate; day++) {
            ...
            if (thisDate.toDateString() === selectedDate.toDateString()) dayCell.classList.add('selected');
    ...
    function renderEvents() {
        ...
        eventsDateLabel.textContent = selectedDate.toLocaleDateString('en-US', {
            weekday: 'long',
            year: 'numeric',
            month: 'long',
            day: 'numeric'
    ...
    addEventBtn.addEventListener('click', () => {
        ...
        if (date && time && title) {
            ...
            events[date].push({ time, title, done: false });
            saveEvents();
            renderEvents();
            renderCalendar(currentDate);
